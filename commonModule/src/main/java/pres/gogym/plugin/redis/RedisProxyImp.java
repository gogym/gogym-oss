package pres.gogym.plugin.redis;
...
public class RedisProxyImp implements IRedisProxy
{
    ...
    public void saveByToken(String token, String key, String value, Integer validTime)
    {
        ...
        try
        {
            ...
            if (!exists(token))
            {
                ...
                map.put(key, value);
                // jedis.set(token, map.toString());
                setex(key, validTime, map.toString());
            }
            else
            {
                String tmp = get(token);

                Map<String, String> map = FastJsonUtils.toBean(tmp,
    ...
    public String getByToken(String token, String key)
    {
